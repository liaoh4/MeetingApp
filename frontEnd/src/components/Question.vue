<template>
  <div>
    <div class='QnA'>
      ...
      <div v-if='visible'>
        <Answer v-for='(answer, i) in question.answers' :key="i+answer+question.id" class="answer">
          Answer: {{ answer }}
        </Answer>
        <div class='ansBox'>
...
export default {
  ...
  methods: {
    ...
    postAnswer: function(){
      ...
      axios.post(url+':3000/query/answer/'+encodeURIComponent(this.question.question), {
